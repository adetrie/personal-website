                        ...
                        <div className="grid grid-cols-2 place-items-stretch mt-5">
                            ...
                            <div>
                                <ul>
                                    ...
                                    <li><span className="underline decoration-2 text-lg decoration-emerald-400">Langues :</span><span>&nbsp; Français (Natif) / Anglais (TOEIC 700)</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>

                    <div className="lg:w-1/2 lg:h-1/2 w-full flex pt-10 lg:pt-0">
                        <div className="w-1/2 rounded shadow hover:rotate-1 transition-transform border border-amber-400 p-3 m-1 lg:m-2 bg-amber-100">
                            <ul>
                                ...
                                <li><span className="border-b-2 border-amber-400 -pt-10">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                    <span className="text-l text-black pl-2">En tant qu'IT Solution Architect</span>
                                </li>
                            </ul>
                        </div>
