    ...
    return (
        <section id="section-about" className="min-h-screen items-center justify-center pt-20">
            ...
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0 text-9xl text-center lg:text-right">
                    😁
                </div>
                <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center bg-gray-200 border-solid border-1 rounded-3xl shadow-xl hover:rotate-1 transition-transform lg:p-10 p-5">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                         className="inline-block w-8 h-8 text-red-500 mb-8" viewBox="0 0 975.036 975.036">
                        <path
                    ...
                    <span className="inline-block h-1 w-24 rounded bg-amber-400 mt-8 mb-6"></span>
                    <h2 className="tracking-wider">Alexis Détrie</h2>
                    <p className="">Développeur et Architecte Java</p>
                </div>
            </div>
        </section>
    );
