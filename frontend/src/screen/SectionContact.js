            ...
            <section id="section-contact" className="text-gray-600 body-font relative">
                ...
                <div className="container px-5 py-24 mx-auto flex">
                    <div
                        ...
                        <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Contactez-moi</h2>
                        <p className="leading-relaxed mb-5 text-gray-600">Si tu souhaites plus d'information, n'hésite
